# =========================================================================
# VENDORED FILE -- do not edit beyond what is noted below.
#
# Source: https://github.com/nguwijy/deep_branching, file galerkin.py,
# commit c06bef2 ("move multidimensional_burgers.ipynb"), MIT License
# (Copyright (c) 2022 nguwijy).  Deep Galerkin method (DGM) of
# Sirignano & Spiliopoulos, used as a comparison baseline for JCP2024
# Tables 1/3.  NOTE: the DGM residual is dt u + f with f supplied by the
# CALLER -- it must contain the full spatial operator including the
# (sigma^2/2) Laplacian.  Vendored verbatim for M5; only this header was
# added.  Interface adapters live in parabolab/vendor/adapters.py.
# =========================================================================
import time
import torch
