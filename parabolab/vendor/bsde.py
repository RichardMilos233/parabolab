...
#
# Source: https://github.com/nguwijy/deep_branching, file bsde.py,
# commit c06bef2 ("move multidimensional_burgers.ipynb"), MIT License
# (Copyright (c) 2022 nguwijy).  Deep BSDE solver of E, Han & Jentzen
# (classical, second_order=False) and Beck et al. 2BSDE
# (second_order=True), used as comparison baselines for JCP2024
# Tables 1/3/5.  Vendored verbatim for M5; only this header was added.
# Interface adapters live in parabolab/vendor/adapters.py.
# =========================================================================
import time
import math
import torch
